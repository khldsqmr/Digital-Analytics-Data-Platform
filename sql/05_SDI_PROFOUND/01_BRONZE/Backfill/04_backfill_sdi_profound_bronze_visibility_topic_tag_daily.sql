...
/* =================================================================================================
FILE: 04_backfill_sdi_profound_bronze_visibility_topic_tag_daily.sql
...
PURPOSE:
  Backfill historical ProFound Visibility Topic+Tag Daily into Bronze using the SAME logic as incremental,
...
LOOP
  ...
  MERGE `prj-dbi-prd-1.ds_dbi_digitalmedia_automation.sdi_profound_bronze_visibility_topic_tag_daily` T
  USING (
    WITH src AS (
      SELECT
