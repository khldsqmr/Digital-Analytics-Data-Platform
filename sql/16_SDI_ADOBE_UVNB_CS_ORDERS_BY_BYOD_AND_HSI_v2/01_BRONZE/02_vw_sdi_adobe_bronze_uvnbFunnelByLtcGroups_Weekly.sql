/* =================================================================================================
FILE: 02_vw_sdi_adobe_bronze_uvnbFunnelByLtcGroups_Weekly.sql
LAYER: Bronze View
...
SOURCES:
  ...
  Adobe Experience Cloud (EC) sources, added after the UVNB and Cartstart metrics (before Orders):
...
PURPOSE:
  Canonical Bronze weekly Adobe UVNB, Cartstart, EC, and Orders source mart at LTC_GROUPS granularity.
  ...
  EcCompleted and EcSuccessful are Adobe Experience Cloud metrics, independent of the
  UVNB/Cartstart/Orders funnel metrics — not derived from them.
...
WITH RawUnion AS (
  ...
  UNION ALL SELECT DATE_ADD(PARSE_DATE('%Y%m%d', date_yyyymmdd), INTERVAL 6 DAY), 'LTC_GROUPS', CAST(NULL AS STRING), 'DIRECT', 'EcCompleted', SAFE_CAST(page_events AS FLOAT64), 'sdi_raw_adobe_pp_ec_direct_ec_completed_weekly_tmo', __insert_date, File_Load_datetime, Filename FROM `prj-dbi-prd-1.ds_dbi_improvado_master.sdi_raw_adobe_pp_ec_direct_ec_completed_weekly_tmo`
  UNION ALL SELECT DATE_ADD(PARSE_DATE('%Y%m%d', date_yyyymmdd), INTERVAL 6 DAY), 'LTC_GROUPS', CAST(NULL AS STRING), 'DIRECT', 'EcSuccessful', SAFE_CAST(visits AS FLOAT64), 'sdi_raw_adobe_pp_ec_direct_ec_successful_visits_weekly_tmo', __insert_date, File_Load_datetime, Filename FROM `prj-dbi-prd-1.ds_dbi_improvado_master.sdi_raw_adobe_pp_ec_direct_ec_successful_visits_weekly_tmo`
  ...
  UNION ALL SELECT DATE_ADD(PARSE_DATE('%Y%m%d', date_yyyymmdd), INTERVAL 6 DAY), 'LTC_GROUPS', CAST(NULL AS STRING), 'ORGANIC SEARCH', 'EcCompleted', SAFE_CAST(page_events AS FLOAT64), 'sdi_raw_adobe_pp_ec_organic_search_ec_completed_weekly_tmo', __insert_date, File_Load_datetime, Filename FROM `prj-dbi-prd-1.ds_dbi_improvado_master.sdi_raw_adobe_pp_ec_organic_search_ec_completed_weekly_tmo`
  UNION ALL SELECT DATE_ADD(PARSE_DATE('%Y%m%d', date_yyyymmdd), INTERVAL 6 DAY), 'LTC_GROUPS', CAST(NULL AS STRING), 'ORGANIC SEARCH', 'EcSuccessful', SAFE_CAST(visits AS FLOAT64), 'sdi_raw_adobe_pp_ec_organic_search_ec_successful_visits_weekly_tmo', __insert_date, File_Load_datetime, Filename FROM `prj-dbi-prd-1.ds_dbi_improvado_master.sdi_raw_adobe_pp_ec_organic_search_ec_successful_visits_weekly_tmo`
  ...
  UNION ALL SELECT DATE_ADD(PARSE_DATE('%Y%m%d', date_yyyymmdd), INTERVAL 6 DAY), 'LTC_GROUPS', CAST(NULL AS STRING), 'OTHER', 'EcCompleted', SAFE_CAST(page_events AS FLOAT64), 'sdi_raw_adobe_pp_ec_other_ec_completed_weekly_tmo', __insert_date, File_Load_datetime, Filename FROM `prj-dbi-prd-1.ds_dbi_improvado_master.sdi_raw_adobe_pp_ec_other_ec_completed_weekly_tmo`
  UNION ALL SELECT DATE_ADD(PARSE_DATE('%Y%m%d', date_yyyymmdd), INTERVAL 6 DAY), 'LTC_GROUPS', CAST(NULL AS STRING), 'OTHER', 'EcSuccessful', SAFE_CAST(visits AS FLOAT64), 'sdi_raw_adobe_pp_ec_other_ec_successful_visits_weekly_tmo', __insert_date, File_Load_datetime, Filename FROM `prj-dbi-prd-1.ds_dbi_improvado_master.sdi_raw_adobe_pp_ec_other_ec_successful_visits_weekly_tmo`
  ...
  UNION ALL SELECT DATE_ADD(PARSE_DATE('%Y%m%d', date_yyyymmdd), INTERVAL 6 DAY), 'LTC_GROUPS', CAST(NULL AS STRING), 'PAID SEARCH', 'EcCompleted', SAFE_CAST(page_events AS FLOAT64), 'sdi_raw_adobe_pp_ec_paid_search_ec_completed_weekly_tmo', __insert_date, File_Load_datetime, Filename FROM `prj-dbi-prd-1.ds_dbi_improvado_master.sdi_raw_adobe_pp_ec_paid_search_ec_completed_weekly_tmo`
  UNION ALL SELECT DATE_ADD(PARSE_DATE('%Y%m%d', date_yyyymmdd), INTERVAL 6 DAY), 'LTC_GROUPS', CAST(NULL AS STRING), 'PAID SEARCH', 'EcSuccessful', SAFE_CAST(visits AS FLOAT64), 'sdi_raw_adobe_pp_ec_paid_search_ec_successful_visits_weekly_tmo', __insert_date, File_Load_datetime, Filename FROM `prj-dbi-prd-1.ds_dbi_improvado_master.sdi_raw_adobe_pp_ec_paid_search_ec_successful_visits_weekly_tmo`
  ...
  UNION ALL SELECT DATE_ADD(PARSE_DATE('%Y%m%d', date_yyyymmdd), INTERVAL 6 DAY), 'LTC_GROUPS', CAST(NULL AS STRING), 'PROGRAMMATIC', 'EcCompleted', SAFE_CAST(page_events AS FLOAT64), 'sdi_raw_adobe_pp_ec_programmatic_ec_completed_weekly_tmo', __insert_date, File_Load_datetime, Filename FROM `prj-dbi-prd-1.ds_dbi_improvado_master.sdi_raw_adobe_pp_ec_programmatic_ec_completed_weekly_tmo`
  UNION ALL SELECT DATE_ADD(PARSE_DATE('%Y%m%d', date_yyyymmdd), INTERVAL 6 DAY), 'LTC_GROUPS', CAST(NULL AS STRING), 'PROGRAMMATIC', 'EcSuccessful', SAFE_CAST(visits AS FLOAT64), 'sdi_raw_adobe_pp_ec_programmatic_ec_successful_visits_weekly_tmo', __insert_date, File_Load_datetime, Filename FROM `prj-dbi-prd-1.ds_dbi_improvado_master.sdi_raw_adobe_pp_ec_programmatic_ec_successful_visits_weekly_tmo`
  ...
  UNION ALL SELECT DATE_ADD(PARSE_DATE('%Y%m%d', date_yyyymmdd), INTERVAL 6 DAY), 'LTC_GROUPS', CAST(NULL AS STRING), 'SOCIAL', 'EcCompleted', SAFE_CAST(page_events AS FLOAT64), 'sdi_raw_adobe_pp_ec_social_ec_completed_weekly_tmo', __insert_date, File_Load_datetime, Filename FROM `prj-dbi-prd-1.ds_dbi_improvado_master.sdi_raw_adobe_pp_ec_social_ec_completed_weekly_tmo`
  UNION ALL SELECT DATE_ADD(PARSE_DATE('%Y%m%d', date_yyyymmdd), INTERVAL 6 DAY), 'LTC_GROUPS', CAST(NULL AS STRING), 'SOCIAL', 'EcSuccessful', SAFE_CAST(visits AS FLOAT64), 'sdi_raw_adobe_pp_ec_social_ec_successful_visits_weekly_tmo', __insert_date, File_Load_datetime, Filename FROM `prj-dbi-prd-1.ds_dbi_improvado_master.sdi_raw_adobe_pp_ec_social_ec_successful_visits_weekly_tmo`
