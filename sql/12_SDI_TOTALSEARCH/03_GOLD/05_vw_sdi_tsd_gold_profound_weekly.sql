...
PURPOSE:
  Gold weekly ProFound / GoFish reporting view for the Total Search Dashboard.
...
CREATE OR REPLACE VIEW `prj-dbi-prd-1.ds_dbi_digitalmedia_automation.vw_sdi_tsd_gold_profound_weekly`
AS
