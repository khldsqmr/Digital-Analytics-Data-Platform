/* =================================================================================================
FILE: 03_merge_sdi_profound_bronze_visibility_tag_topic_weekly.sql
LAYER: Bronze
DATASET: prj-dbi-prd-1.ds_dbi_digitalmedia_automation
TARGET TABLE: sdi_profound_bronze_visibility_tag_topic_weekly

SOURCE (RAW):
  prj-dbi-prd-1.ds_dbi_improvado_master.sdi_seo_profound_vis_tag_topic_weekly_tmo

PURPOSE:
  Refresh Bronze ProFound Visibility Tag Topic Weekly using date-scoped delete + insert.
