...
/* =================================================================================================
FILE: 03_sp_merge_sdi_bronze_seo_profound_visibility_topic_daily.sql
LAYER: Bronze
DATASET: prj-dbi-prd-1.ds_dbi_digitalmedia_automation
PROC:  sp_merge_bronze_seo_profound_visibility_topic_daily
TARGET TABLE: sdi_bronze_seo_profound_visibility_topic_daily

PURPOSE:
  Incrementally upsert ProFound Visibility Topic Daily into Bronze:
...
`prj-dbi-prd-1.ds_dbi_digitalmedia_automation.sp_merge_bronze_seo_profound_visibility_topic_daily`()
