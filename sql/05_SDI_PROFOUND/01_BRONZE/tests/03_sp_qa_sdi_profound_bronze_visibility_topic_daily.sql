...
TARGET: sdi_profound_bronze_visibility_topic_daily
...
BEGIN
  ...
  DECLARE table_name STRING DEFAULT 'sdi_profound_bronze_visibility_topic_daily';
  ...
  SELECT
    account_id, asset_name, topic, date_yyyymmdd, date,
