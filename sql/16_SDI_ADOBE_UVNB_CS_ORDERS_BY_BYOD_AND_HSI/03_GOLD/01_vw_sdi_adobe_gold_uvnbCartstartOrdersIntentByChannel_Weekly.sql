/* =================================================================================================
FILE: 01_vw_sdi_adobe_gold_uvnbCartstartOrdersIntentByChannel_Weekly.sql
LAYER: Gold View
DATASET: prj-dbi-prd-1.ds_dbi_digitalmedia_automation
VIEW: vw_sdi_adobe_gold_uvnbCartstartOrdersIntentByChannel_Weekly

SOURCE:
  prj-dbi-prd-1.ds_dbi_digitalmedia_automation.vw_sdi_adobe_silver_uvnbCartstartOrdersByChannelPlusAll_Weekly

DESTINATION:
  prj-dbi-prd-1.ds_dbi_digitalmedia_automation.vw_sdi_adobe_gold_uvnbCartstartOrdersIntentByChannel_Weekly

PURPOSE:
  Weekly business-facing intent and conversion view by Channel.
...
BUSINESS RULES:
  ...
  - Channel rows come directly from Adobe LTC tables through Bronze/Silver.
...
WITH Base AS (
  ...
  FROM `prj-dbi-prd-1.ds_dbi_digitalmedia_automation.vw_sdi_adobe_silver_uvnbCartstartOrdersByChannelPlusAll_Weekly`
),
