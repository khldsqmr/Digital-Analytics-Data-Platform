...
QGP WEEK (bucket end date):
  - Normal weeks: week ending Saturday (Sun→Sat)
  - Quarter-end partial bucket: quarter_end_date (e.g., Sep 30)
  - The remaining days after quarter end in that same week roll into that Saturday bucket
    (e.g., Oct 1–Oct 4 => qgp_week = Oct 4)
...
(
  ...
  account_id STRING,
  campaign_id STRING,
  qgp_week DATE OPTIONS(description="Bucket end date: Saturday week-end OR quarter-end date."),

  -- ============================================================
  -- DIMENSIONS (deterministic: latest within bucket)
  -- ============================================================
  account_name STRING,
  lob STRING,
  ad_platform STRING,
...
OPTIONS(
  description = "Gold SA360 campaign WEEKLY dashboard table. qgp_week = Saturdays + quarter-end partial buckets."
);
