/* =================================================================================================
FILE: 04_merge_sdi_profound_bronze_citationDomain_weekly.sql
LAYER: Bronze
DATASET: prj-dbi-prd-1.ds_dbi_digitalmedia_automation
TARGET TABLE: sdi_profound_bronze_citationDomain_weekly

SOURCE (RAW):
  prj-dbi-prd-1.ds_dbi_improvado_master.sdi_seo_profound_cit_domain_weekly_tmo

PURPOSE:
  Refresh Bronze ProFound Citation Domain Weekly using date-scoped delete + insert.
