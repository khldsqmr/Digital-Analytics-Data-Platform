/* =================================================================================================
FILE: 02_sp_reconcile_backfill_sdi_profound_bronze_visibility_tag_daily.sql
LAYER: Bronze
PROC:  sp_reconcile_backfill_sdi_profound_bronze_visibility_tag_daily
...
`prj-dbi-prd-1.ds_dbi_digitalmedia_automation.sp_reconcile_backfill_sdi_profound_bronze_visibility_tag_daily`(
  p_start_date DATE,
  p_end_date   DATE
)
