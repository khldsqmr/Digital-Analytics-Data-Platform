/*
===============================================================================
FILE: 01_backfill_bronze_sa360_campaign_entity.sql
LAYER: Bronze (One-time Backfill)
TARGET: prj-dbi-prd-1.ds_dbi_digitalmedia_automation.sdi_bronze_sa360_campaign_entity
SOURCE: prj-dbi-prd-1.ds_dbi_improvado_master.google_search_ads_360_beta_campaign_entity_custom_tmo
===============================================================================
*/
...
LOOP
  ...
  WHEN NOT MATCHED THEN INSERT (
    ...
    final_url_suffix, frequency_caps, labels, language_code,
  ...
  VALUES (
    ...
    S.final_url_suffix, S.frequency_caps, S.labels, S.language_code,
