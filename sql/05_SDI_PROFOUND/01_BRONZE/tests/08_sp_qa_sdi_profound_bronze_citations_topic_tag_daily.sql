...
TARGET: sdi_profound_bronze_citations_topic_tag_daily
...
BEGIN
  ...
  DECLARE table_name STRING DEFAULT 'sdi_profound_bronze_citations_topic_tag_daily';
  ...
  SELECT
    account_id, root_domain, topic, tag, date_yyyymmdd, date,
