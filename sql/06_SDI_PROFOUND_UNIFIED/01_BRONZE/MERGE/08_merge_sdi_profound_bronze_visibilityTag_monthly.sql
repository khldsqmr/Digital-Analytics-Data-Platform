/* =================================================================================================
FILE: 08_merge_sdi_profound_bronze_visibility_tag_monthly.sql
LAYER: Bronze
DATASET: prj-dbi-prd-1.ds_dbi_digitalmedia_automation
TARGET TABLE: sdi_profound_bronze_visibility_tag_monthly

SOURCE (RAW):
  prj-dbi-prd-1.ds_dbi_improvado_master.sdi_seo_profound_vis_tag_monthly_tmo

PURPOSE:
  Refresh Bronze ProFound Visibility Tag Monthly using date-scoped delete + insert.
