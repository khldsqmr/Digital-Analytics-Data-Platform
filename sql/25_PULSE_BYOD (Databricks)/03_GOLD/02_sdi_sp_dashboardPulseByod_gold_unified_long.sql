...
PURPOSE:
  ...
  Each Silver table is unpivoted independently and stacked with UNION ALL.
  One row per metric per week.

ACTIVE SOURCES:
  profound, profoundGofish, sa360, gsc, googleTrends,
  adobe, adobeByodEntryPages, adobeByodOutcomes

IMPORTANT CORRECTION:
  Databricks UNPIVOT aliases are identifiers and therefore use backticks,
  for example AS `metric_name`, not string literals such as AS 'metric_name'.
================================================================================================= */

CREATE OR REPLACE PROCEDURE prdrzranalytics.lab42.sdi_sp_dashboardPulseByod_gold_unified_long()
LANGUAGE SQL
...
BEGIN
  ...
  CREATE OR REPLACE TABLE prdrzranalytics.lab42.sdi_tbl_dashboardPulseByod_gold_unified_long
  USING DELTA
  AS

  WITH
  profound_long AS (
      SELECT week_sun_to_sat, data_source, channel, max_data_date, metric_name,
  ...
  trends_keywords_long AS (
      SELECT week_sun_to_sat, data_source, channel, max_data_date, 'KEYWORD_RANK_1' AS dimension_name, trends_top_kw_1 AS dimension_value, 'trends_kw_interest' AS metric_name, CAST(trends_kw1_interest AS DOUBLE) AS metric_value, CAST(NULL AS DOUBLE) AS metric_value_wow, CAST(NULL AS DOUBLE) AS metric_value_ly, CAST(NULL AS DOUBLE) AS wow_pct, CAST(NULL AS DOUBLE) AS yoy_pct FROM prdrzranalytics.lab42.sdi_tbl_dashboardPulseByod_silver_googleTrends_weekly WHERE NULLIF(TRIM(trends_top_kw_1), '') IS NOT NULL
      UNION ALL
      SELECT week_sun_to_sat, data_source, channel, max_data_date, 'KEYWORD_RANK_1' AS dimension_name, trends_top_kw_1 AS dimension_value, 'trends_kw_change' AS metric_name, CAST(trends_kw1_change AS DOUBLE) AS metric_value, CAST(NULL AS DOUBLE) AS metric_value_wow, CAST(NULL AS DOUBLE) AS metric_value_ly, CAST(NULL AS DOUBLE) AS wow_pct, CAST(NULL AS DOUBLE) AS yoy_pct FROM prdrzranalytics.lab42.sdi_tbl_dashboardPulseByod_silver_googleTrends_weekly WHERE NULLIF(TRIM(trends_top_kw_1), '') IS NOT NULL
      UNION ALL
      SELECT week_sun_to_sat, data_source, channel, max_data_date, 'KEYWORD_RANK_2' AS dimension_name, trends_top_kw_2 AS dimension_value, 'trends_kw_interest' AS metric_name, CAST(trends_kw2_interest AS DOUBLE) AS metric_value, CAST(NULL AS DOUBLE) AS metric_value_wow, CAST(NULL AS DOUBLE) AS metric_value_ly, CAST(NULL AS DOUBLE) AS wow_pct, CAST(NULL AS DOUBLE) AS yoy_pct FROM prdrzranalytics.lab42.sdi_tbl_dashboardPulseByod_silver_googleTrends_weekly WHERE NULLIF(TRIM(trends_top_kw_2), '') IS NOT NULL
      UNION ALL
      SELECT week_sun_to_sat, data_source, channel, max_data_date, 'KEYWORD_RANK_2' AS dimension_name, trends_top_kw_2 AS dimension_value, 'trends_kw_change' AS metric_name, CAST(trends_kw2_change AS DOUBLE) AS metric_value, CAST(NULL AS DOUBLE) AS metric_value_wow, CAST(NULL AS DOUBLE) AS metric_value_ly, CAST(NULL AS DOUBLE) AS wow_pct, CAST(NULL AS DOUBLE) AS yoy_pct FROM prdrzranalytics.lab42.sdi_tbl_dashboardPulseByod_silver_googleTrends_weekly WHERE NULLIF(TRIM(trends_top_kw_2), '') IS NOT NULL
      UNION ALL
      SELECT week_sun_to_sat, data_source, channel, max_data_date, 'KEYWORD_RANK_3' AS dimension_name, trends_top_kw_3 AS dimension_value, 'trends_kw_interest' AS metric_name, CAST(trends_kw3_interest AS DOUBLE) AS metric_value, CAST(NULL AS DOUBLE) AS metric_value_wow, CAST(NULL AS DOUBLE) AS metric_value_ly, CAST(NULL AS DOUBLE) AS wow_pct, CAST(NULL AS DOUBLE) AS yoy_pct FROM prdrzranalytics.lab42.sdi_tbl_dashboardPulseByod_silver_googleTrends_weekly WHERE NULLIF(TRIM(trends_top_kw_3), '') IS NOT NULL
      UNION ALL
      SELECT week_sun_to_sat, data_source, channel, max_data_date, 'KEYWORD_RANK_3' AS dimension_name, trends_top_kw_3 AS dimension_value, 'trends_kw_change' AS metric_name, CAST(trends_kw3_change AS DOUBLE) AS metric_value, CAST(NULL AS DOUBLE) AS metric_value_wow, CAST(NULL AS DOUBLE) AS metric_value_ly, CAST(NULL AS DOUBLE) AS wow_pct, CAST(NULL AS DOUBLE) AS yoy_pct FROM prdrzranalytics.lab42.sdi_tbl_dashboardPulseByod_silver_googleTrends_weekly WHERE NULLIF(TRIM(trends_top_kw_3), '') IS NOT NULL
      UNION ALL
      SELECT week_sun_to_sat, data_source, channel, max_data_date, 'KEYWORD_RANK_4' AS dimension_name, trends_top_kw_4 AS dimension_value, 'trends_kw_interest' AS metric_name, CAST(trends_kw4_interest AS DOUBLE) AS metric_value, CAST(NULL AS DOUBLE) AS metric_value_wow, CAST(NULL AS DOUBLE) AS metric_value_ly, CAST(NULL AS DOUBLE) AS wow_pct, CAST(NULL AS DOUBLE) AS yoy_pct FROM prdrzranalytics.lab42.sdi_tbl_dashboardPulseByod_silver_googleTrends_weekly WHERE NULLIF(TRIM(trends_top_kw_4), '') IS NOT NULL
      UNION ALL
      SELECT week_sun_to_sat, data_source, channel, max_data_date, 'KEYWORD_RANK_4' AS dimension_name, trends_top_kw_4 AS dimension_value, 'trends_kw_change' AS metric_name, CAST(trends_kw4_change AS DOUBLE) AS metric_value, CAST(NULL AS DOUBLE) AS metric_value_wow, CAST(NULL AS DOUBLE) AS metric_value_ly, CAST(NULL AS DOUBLE) AS wow_pct, CAST(NULL AS DOUBLE) AS yoy_pct FROM prdrzranalytics.lab42.sdi_tbl_dashboardPulseByod_silver_googleTrends_weekly WHERE NULLIF(TRIM(trends_top_kw_4), '') IS NOT NULL
      UNION ALL
      SELECT week_sun_to_sat, data_source, channel, max_data_date, 'KEYWORD_RANK_5' AS dimension_name, trends_top_kw_5 AS dimension_value, 'trends_kw_interest' AS metric_name, CAST(trends_kw5_interest AS DOUBLE) AS metric_value, CAST(NULL AS DOUBLE) AS metric_value_wow, CAST(NULL AS DOUBLE) AS metric_value_ly, CAST(NULL AS DOUBLE) AS wow_pct, CAST(NULL AS DOUBLE) AS yoy_pct FROM prdrzranalytics.lab42.sdi_tbl_dashboardPulseByod_silver_googleTrends_weekly WHERE NULLIF(TRIM(trends_top_kw_5), '') IS NOT NULL
      UNION ALL
      SELECT week_sun_to_sat, data_source, channel, max_data_date, 'KEYWORD_RANK_5' AS dimension_name, trends_top_kw_5 AS dimension_value, 'trends_kw_change' AS metric_name, CAST(trends_kw5_change AS DOUBLE) AS metric_value, CAST(NULL AS DOUBLE) AS metric_value_wow, CAST(NULL AS DOUBLE) AS metric_value_ly, CAST(NULL AS DOUBLE) AS wow_pct, CAST(NULL AS DOUBLE) AS yoy_pct FROM prdrzranalytics.lab42.sdi_tbl_dashboardPulseByod_silver_googleTrends_weekly WHERE NULLIF(TRIM(trends_top_kw_5), '') IS NOT NULL
  ),

  adobe_long AS (
      SELECT week_sun_to_sat, data_source, max_data_date, metric_name,
             metric_value, metric_value_wow, metric_value_ly, wow_pct, yoy_pct
      FROM prdrzranalytics.lab42.sdi_tbl_dashboardPulseByod_silver_adobe_weekly
      UNPIVOT (
          (metric_value, metric_value_wow, metric_value_ly, wow_pct, yoy_pct)
          FOR metric_name IN (
              (adobe_upvByod_allChannels, adobe_upvByod_allChannels_wow, adobe_upvByod_allChannels_ly, adobe_upvByod_allChannels_wow_pct, adobe_upvByod_allChannels_yoy_pct) AS `adobe_upvByod_allChannels`,
              (adobe_upvTotal_allChannels, adobe_upvTotal_allChannels_wow, adobe_upvTotal_allChannels_ly, adobe_upvTotal_allChannels_wow_pct, adobe_upvTotal_allChannels_yoy_pct) AS `adobe_upvTotal_allChannels`,
              (adobe_upvFlowTotal_allChannels, adobe_upvFlowTotal_allChannels_wow, adobe_upvFlowTotal_allChannels_ly, adobe_upvFlowTotal_allChannels_wow_pct, adobe_upvFlowTotal_allChannels_yoy_pct) AS `adobe_upvFlowTotal_allChannels`,
              (adobe_pctUpvByodOfUpvFlow_allChannels, adobe_pctUpvByodOfUpvFlow_allChannels_wow, adobe_pctUpvByodOfUpvFlow_allChannels_ly, adobe_pctUpvByodOfUpvFlow_allChannels_wow_pct, adobe_pctUpvByodOfUpvFlow_allChannels_yoy_pct) AS `adobe_pctUpvByodOfUpvFlow_allChannels`,
              ...
              (adobe_upvByod_paidSearch, adobe_upvByod_paidSearch_wow, adobe_upvByod_paidSearch_ly, adobe_upvByod_paidSearch_wow_pct, adobe_upvByod_paidSearch_yoy_pct) AS `adobe_upvByod_paidSearch`,
              (adobe_pctUpvByodOfTotal_paidSearch, adobe_pctUpvByodOfTotal_paidSearch_wow, adobe_pctUpvByodOfTotal_paidSearch_ly, adobe_pctUpvByodOfTotal_paidSearch_wow_pct, adobe_pctUpvByodOfTotal_paidSearch_yoy_pct) AS `adobe_pctUpvByodOfTotal_paidSearch`,
              ...
              (adobe_upvByod_organicSearch, adobe_upvByod_organicSearch_wow, adobe_upvByod_organicSearch_ly, adobe_upvByod_organicSearch_wow_pct, adobe_upvByod_organicSearch_yoy_pct) AS `adobe_upvByod_organicSearch`,
              (adobe_pctUpvByodOfTotal_organicSearch, adobe_pctUpvByodOfTotal_organicSearch_wow, adobe_pctUpvByodOfTotal_organicSearch_ly, adobe_pctUpvByodOfTotal_organicSearch_wow_pct, adobe_pctUpvByodOfTotal_organicSearch_yoy_pct) AS `adobe_pctUpvByodOfTotal_organicSearch`,
              ...
              (adobe_upvByod_direct, adobe_upvByod_direct_wow, adobe_upvByod_direct_ly, adobe_upvByod_direct_wow_pct, adobe_upvByod_direct_yoy_pct) AS `adobe_upvByod_direct`,
              (adobe_pctUpvByodOfTotal_direct, adobe_pctUpvByodOfTotal_direct_wow, adobe_pctUpvByodOfTotal_direct_ly, adobe_pctUpvByodOfTotal_direct_wow_pct, adobe_pctUpvByodOfTotal_direct_yoy_pct) AS `adobe_pctUpvByodOfTotal_direct`,
              ...
              (adobe_upvByod_social, adobe_upvByod_social_wow, adobe_upvByod_social_ly, adobe_upvByod_social_wow_pct, adobe_upvByod_social_yoy_pct) AS `adobe_upvByod_social`,
              (adobe_pctUpvByodOfTotal_social, adobe_pctUpvByodOfTotal_social_wow, adobe_pctUpvByodOfTotal_social_ly, adobe_pctUpvByodOfTotal_social_wow_pct, adobe_pctUpvByodOfTotal_social_yoy_pct) AS `adobe_pctUpvByodOfTotal_social`,
              ...
              (adobe_upvByod_programmatic, adobe_upvByod_programmatic_wow, adobe_upvByod_programmatic_ly, adobe_upvByod_programmatic_wow_pct, adobe_upvByod_programmatic_yoy_pct) AS `adobe_upvByod_programmatic`,
              (adobe_pctUpvByodOfTotal_programmatic, adobe_pctUpvByodOfTotal_programmatic_wow, adobe_pctUpvByodOfTotal_programmatic_ly, adobe_pctUpvByodOfTotal_programmatic_wow_pct, adobe_pctUpvByodOfTotal_programmatic_yoy_pct) AS `adobe_pctUpvByodOfTotal_programmatic`,
              ...
              (adobe_upvByod_other, adobe_upvByod_other_wow, adobe_upvByod_other_ly, adobe_upvByod_other_wow_pct, adobe_upvByod_other_yoy_pct) AS `adobe_upvByod_other`,
              (adobe_pctUpvByodOfTotal_other, adobe_pctUpvByodOfTotal_other_wow, adobe_pctUpvByodOfTotal_other_ly, adobe_pctUpvByodOfTotal_other_wow_pct, adobe_pctUpvByodOfTotal_other_yoy_pct) AS `adobe_pctUpvByodOfTotal_other`,
  ...
  entryPages_long AS (
      ...
      UNPIVOT (
          (metric_value, metric_value_wow, metric_value_ly, wow_pct, yoy_pct)
          FOR metric_name IN (
              (adobe_byodUpvVisitors_allChannels, adobe_byodUpvVisitors_allChannels_wow, adobe_byodUpvVisitors_allChannels_ly, adobe_byodUpvVisitors_allChannels_wow_pct, adobe_byodUpvVisitors_allChannels_yoy_pct) AS `adobe_byodUpvVisitors_allChannels`,
              ...
              (adobe_byodEntryGetStartedLandingPageVisitors_allChannels, adobe_byodEntryGetStartedLandingPageVisitors_allChannels_wow, adobe_byodEntryGetStartedLandingPageVisitors_allChannels_ly, adobe_byodEntryGetStartedLandingPageVisitors_allChannels_wow_pct, adobe_byodEntryGetStartedLandingPageVisitors_allChannels_yoy_pct) AS `adobe_byodEntryGetStartedLandingPageVisitors_allChannels`,
              ...
              (adobe_byodEntryOffersSwitchVisitors_allChannels, adobe_byodEntryOffersSwitchVisitors_allChannels_wow, adobe_byodEntryOffersSwitchVisitors_allChannels_ly, adobe_byodEntryOffersSwitchVisitors_allChannels_wow_pct, adobe_byodEntryOffersSwitchVisitors_allChannels_yoy_pct) AS `adobe_byodEntryOffersSwitchVisitors_allChannels`,
              (adobe_byodUpvVisitors_paidSearch, adobe_byodUpvVisitors_paidSearch_wow, adobe_byodUpvVisitors_paidSearch_ly, adobe_byodUpvVisitors_paidSearch_wow_pct, adobe_byodUpvVisitors_paidSearch_yoy_pct) AS `adobe_byodUpvVisitors_paidSearch`,
              ...
              (adobe_byodEntryOffersSwitchVisitors_paidSearch, adobe_byodEntryOffersSwitchVisitors_paidSearch_wow, adobe_byodEntryOffersSwitchVisitors_paidSearch_ly, adobe_byodEntryOffersSwitchVisitors_paidSearch_wow_pct, adobe_byodEntryOffersSwitchVisitors_paidSearch_yoy_pct) AS `adobe_byodEntryOffersSwitchVisitors_paidSearch`,
              (adobe_byodUpvVisitors_organicSearch, adobe_byodUpvVisitors_organicSearch_wow, adobe_byodUpvVisitors_organicSearch_ly, adobe_byodUpvVisitors_organicSearch_wow_pct, adobe_byodUpvVisitors_organicSearch_yoy_pct) AS `adobe_byodUpvVisitors_organicSearch`,
              ...
              (adobe_byodEntryOffersSwitchVisitors_direct, adobe_byodEntryOffersSwitchVisitors_direct_wow, adobe_byodEntryOffersSwitchVisitors_direct_ly, adobe_byodEntryOffersSwitchVisitors_direct_wow_pct, adobe_byodEntryOffersSwitchVisitors_direct_yoy_pct) AS `adobe_byodEntryOffersSwitchVisitors_direct`,
              (adobe_byodUpvVisitors_social, adobe_byodUpvVisitors_social_wow, adobe_byodUpvVisitors_social_ly, adobe_byodUpvVisitors_social_wow_pct, adobe_byodUpvVisitors_social_yoy_pct) AS `adobe_byodUpvVisitors_social`,
              ...
              (adobe_byodEntryGetStartedLandingPageVisitors_social, adobe_byodEntryGetStartedLandingPageVisitors_social_wow, adobe_byodEntryGetStartedLandingPageVisitors_social_ly, adobe_byodEntryGetStartedLandingPageVisitors_social_wow_pct, adobe_byodEntryGetStartedLandingPageVisitors_social_yoy_pct) AS `adobe_byodEntryGetStartedLandingPageVisitors_social`,
              (adobe_byodEntryByodLandingPageVisitors_social, adobe_byodEntryByodLandingPageVisitors_social_wow, adobe_byodEntryByodLandingPageVisitors_social_ly, adobe_byodEntryByodLandingPageVisitors_social_wow_pct, adobe_byodEntryByodLandingPageVisitors_social_yoy_pct) AS `adobe_byodEntryByodLandingPageVisitors_social`,
              (adobe_byodEntryOffersSwitchVisitors_social, adobe_byodEntryOffersSwitchVisitors_social_wow, adobe_byodEntryOffersSwitchVisitors_social_ly, adobe_byodEntryOffersSwitchVisitors_social_wow_pct, adobe_byodEntryOffersSwitchVisitors_social_yoy_pct) AS `adobe_byodEntryOffersSwitchVisitors_social`,
              (adobe_byodUpvVisitors_programmatic, adobe_byodUpvVisitors_programmatic_wow, adobe_byodUpvVisitors_programmatic_ly, adobe_byodUpvVisitors_programmatic_wow_pct, adobe_byodUpvVisitors_programmatic_yoy_pct) AS `adobe_byodUpvVisitors_programmatic`,
              ...
              (adobe_byodEntryGetStartedLandingPageVisitors_other, adobe_byodEntryGetStartedLandingPageVisitors_other_wow, adobe_byodEntryGetStartedLandingPageVisitors_other_ly, adobe_byodEntryGetStartedLandingPageVisitors_other_wow_pct, adobe_byodEntryGetStartedLandingPageVisitors_other_yoy_pct) AS `adobe_byodEntryGetStartedLandingPageVisitors_other`,
              (adobe_byodEntryByodLandingPageVisitors_other, adobe_byodEntryByodLandingPageVisitors_other_wow, adobe_byodEntryByodLandingPageVisitors_other_ly, adobe_byodEntryByodLandingPageVisitors_other_wow_pct, adobe_byodEntryByodLandingPageVisitors_other_yoy_pct) AS `adobe_byodEntryByodLandingPageVisitors_other`,
              (adobe_byodEntryOffersSwitchVisitors_other, adobe_byodEntryOffersSwitchVisitors_other_wow, adobe_byodEntryOffersSwitchVisitors_other_ly, adobe_byodEntryOffersSwitchVisitors_other_wow_pct, adobe_byodEntryOffersSwitchVisitors_other_yoy_pct) AS `adobe_byodEntryOffersSwitchVisitors_other`
          )
      )
  ),
  ...
  combined AS (
      ...
      UNION ALL
      SELECT week_sun_to_sat, data_source, CASE
