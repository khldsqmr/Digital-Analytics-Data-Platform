...
/* =================================================================================================
FILE: 01_backfill_sdi_profound_bronze_visibility_asset_daily.sql
...
PURPOSE:
  Backfill historical ProFound Visibility Asset Daily into Bronze using the SAME logic as the
  incremental merge procedure, processed in safe chunks.
...
LOOP
  ...
  MERGE `prj-dbi-prd-1.ds_dbi_digitalmedia_automation.sdi_profound_bronze_visibility_asset_daily` T
  USING (
    WITH src AS (
      SELECT
