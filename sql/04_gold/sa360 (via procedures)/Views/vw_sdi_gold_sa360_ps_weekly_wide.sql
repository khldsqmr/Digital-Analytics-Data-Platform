...
PURPOSE:
  Reporting-friendly weekly wide view using only requested dimensions + all metrics.

NOTES:
  - Gold Weekly already stores qgp_week
  - We aggregate because we are dropping account_id/campaign_id
===============================================================================
*/

CREATE OR REPLACE VIEW `prj-dbi-prd-1.ds_dbi_digitalmedia_automation.vw_gold_sa360_weekly_wide_reporting` AS
SELECT
