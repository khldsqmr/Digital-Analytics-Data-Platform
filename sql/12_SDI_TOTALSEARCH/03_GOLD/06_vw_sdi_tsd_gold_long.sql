...
KEY MODELING NOTES:
  - DAILY granularity is removed entirely
  - Invalid source/channel combinations are filtered out before UNPIVOT
  - This removes non-applicable zero/null rows while preserving real zeroes for valid combinations
