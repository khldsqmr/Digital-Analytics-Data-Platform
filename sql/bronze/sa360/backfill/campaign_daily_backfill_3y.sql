/*
===============================================================================
BACKFILL | BRONZE | SA360 | CAMPAIGN DAILY
===============================================================================

Backfills Bronze Campaign Daily for a historical date range.
...
DEDUPE within range:
  Keep latest row by File_Load_datetime DESC, Filename DESC

DATE RULE:
  - Bronze `date` is parsed from date_yyyymmdd
  - Raw source `date` (INT64) stored as date_serial

TBG/TFB RULE:
  - Standardize TBG metrics into TFB family:
...
-- Safety: If your environment supports ASSERT
-- ASSERT start_date <= end_date AS "start_date must be <= end_date";
