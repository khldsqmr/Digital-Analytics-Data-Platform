/*
===============================================================================
FILE: 01_sp_merge_sdi_gold_sa360_campaign_daily_long.sql
LAYER: Gold
PROC:  sp_merge_gold_sa360_campaign_daily_long

PURPOSE:
  Upsert recent Gold Daily Wide rows into Gold Daily Long.
  - Uses UNPIVOT to generate metric rows
  - Lookback handles late arriving updates
...
`prj-dbi-prd-1.ds_dbi_digitalmedia_automation.sp_merge_gold_sa360_campaign_daily_long`()
...
BEGIN
  ...
  WHEN NOT MATCHED THEN INSERT (
    ...
    file_load_datetime, gold_long_inserted_at
  )
  VALUES (
    ...
    S.file_load_datetime, S.gold_long_inserted_at
  );
