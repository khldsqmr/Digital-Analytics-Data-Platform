...
TARGET: sdi_profound_bronze_citations_topic_daily
...
BEGIN
  ...
  DECLARE table_name STRING DEFAULT 'sdi_profound_bronze_citations_topic_daily';
  ...
  SELECT
    account_id, root_domain, topic, date_yyyymmdd, date,
