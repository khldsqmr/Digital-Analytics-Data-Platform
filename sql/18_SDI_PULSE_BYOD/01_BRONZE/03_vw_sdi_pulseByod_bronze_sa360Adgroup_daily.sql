/* =================================================================================================
FILE:         03_vw_sdi_pulseByod_bronze_sa360Adgroup_daily.sql
LAYER:        Bronze View
...
CREATE OR REPLACE VIEW `prj-dbi-prd-1.ds_dbi_digitalmedia_automation.vw_sdi_pulseByod_bronze_sa360Adgroup_daily`
AS
