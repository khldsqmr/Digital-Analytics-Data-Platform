/*
===============================================================================
FILE: 00_backfill_silver_sa360_campaign_daily.sql
LAYER: Silver (One-time Backfill)
TARGET: prj-dbi-prd-1.ds_dbi_digitalmedia_automation.sdi_silver_sa360_campaign_daily
SOURCES:
  - Bronze Daily:  sdi_bronze_sa360_campaign_daily
  - Bronze Entity: sdi_bronze_sa360_campaign_entity

PURPOSE:
  Backfill Silver daily using your SAME AS-OF enrichment + campaign_name fallback.
===============================================================================
*/
