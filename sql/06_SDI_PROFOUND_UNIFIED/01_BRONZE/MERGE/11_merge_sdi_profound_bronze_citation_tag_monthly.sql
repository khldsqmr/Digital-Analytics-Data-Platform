/* =================================================================================================
FILE: 11_merge_sdi_profound_bronze_citation_tag_monthly.sql
LAYER: Bronze
DATASET: prj-dbi-prd-1.ds_dbi_digitalmedia_automation
TARGET TABLE: sdi_profound_bronze_citation_tag_monthly

SOURCE (RAW):
  prj-dbi-prd-1.ds_dbi_improvado_master.sdi_seo_profound_cit_tag_monthly_tmo

PURPOSE:
  Refresh Bronze ProFound Citation Tag Monthly using date-scoped delete + insert.
