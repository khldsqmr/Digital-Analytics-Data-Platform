/* =================================================================================================
FILE: 02_sp_merge_sdi_bronze_seo_profound_visibility_tag_daily.sql
LAYER: Bronze
DATASET: prj-dbi-prd-1.ds_dbi_digitalmedia_automation
PROC:  sp_merge_bronze_seo_profound_visibility_tag_daily
TARGET TABLE: sdi_bronze_seo_profound_visibility_tag_daily

PURPOSE:
  Incrementally upsert ProFound Visibility Tag Daily into Bronze:
...
`prj-dbi-prd-1.ds_dbi_digitalmedia_automation.sp_merge_bronze_seo_profound_visibility_tag_daily`()
OPTIONS(strict_mode=false)
BEGIN
  DECLARE lookback_days INT64 DEFAULT 60;

  MERGE `prj-dbi-prd-1.ds_dbi_digitalmedia_automation.sdi_bronze_seo_profound_visibility_tag_daily` T
  USING (
    WITH src AS (
      SELECT
