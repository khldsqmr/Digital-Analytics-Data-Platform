...
VIEW: vw_sdi_bronze_sa360_test_dashboard
PURPOSE:
  Latest result per (test_date, table_name, test_layer, test_name) for Bronze.
  Keeps output columns EXACTLY matching sdi_bronze_sa360_test_results schema.
===============================================================================
*/

CREATE OR REPLACE VIEW
`prj-dbi-prd-1.ds_dbi_digitalmedia_automation.vw_sdi_bronze_sa360_test_dashboard` AS
WITH base AS (
  SELECT *
