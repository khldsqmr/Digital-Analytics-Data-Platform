...
PURPOSE:
  ...
  Gold Daily is a curated, stable schema derived from Silver:
    - keeps daily grain
    - keeps key dimensions needed for reporting
    - keeps metrics needed for BI + funnel measurement
...
NOTES:
  - gold_inserted_at is "last upsert timestamp" (i.e., last updated time).
===============================================================================
*/
...
(
  ...
  campaign_id STRING OPTIONS(description="Campaign identifier (SA360)."),
  campaign_name STRING OPTIONS(description="Campaign name (from Silver entity enrichment)."),
  date DATE OPTIONS(description="Daily performance date (UTC date)."),

  -- ===========================================================================
  -- Core reporting dimensions
  -- ===========================================================================
  lob STRING OPTIONS(description="Line of business derived in Silver (e.g., Postpaid/HSI/TFB/etc.)."),
  ad_platform STRING OPTIONS(description="Ad platform derived in Silver (e.g., SA360)."),
  campaign_type STRING OPTIONS(description="Campaign classification derived in Silver (based on naming rules)."),

  advertising_channel_type STRING OPTIONS(description="Advertising channel type from Silver entity."),
  advertising_channel_sub_type STRING OPTIONS(description="Advertising channel sub-type from Silver entity."),
  bidding_strategy_type STRING OPTIONS(description="Bidding strategy type from Silver entity."),
  serving_status STRING OPTIONS(description="Serving status from Silver entity."),

  -- ===========================================================================
  -- Drilldowns (useful for deep-dive / debugging)
  -- ===========================================================================
  ...
  client_manager_id FLOAT64 OPTIONS(description="Client manager ID from Silver (numeric)."),
  ...
  cost FLOAT64 OPTIONS(description="Daily cost (currency units as defined in Silver)."),
  ...
  hint_offline_invoca_sales_opp FLOAT64 OPTIONS(description="HINT offline invoca sales opportunity."),
  ...
  -- ===========================================================================
  -- TMO (IMPORTANT: use consistent naming across Gold)
  -- ===========================================================================
  ...
  tmo_prepaid_low_funnel_prospect FLOAT64 OPTIONS(description="TMO prepaid low funnel prospect (consistent column name)."),
  ...
  -- Lineage
  -- ===========================================================================
  file_load_datetime DATETIME OPTIONS(description="Upstream file load datetime from Silver."),
  gold_inserted_at TIMESTAMP OPTIONS(description="Gold upsert timestamp (last write time).")
)
PARTITION BY date
CLUSTER BY lob, ad_platform, account_id, campaign_id
OPTIONS(
